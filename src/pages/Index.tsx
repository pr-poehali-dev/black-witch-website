...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Усиление финансового потока, привлечение удачи в бизнесе, устранение денежных блоков на пути к достатку. Работа проводится через беса Мафава.",
    price: "от 30 000 ₽",
  },
  {
    icon: "🛡️",
...
const REVIEWS = [
  ...
  },
  {
    name: "Марина С.",
    city: "Новосибирск",
    text: "Заказывала порчу на бывшего партнёра, который годами портил мне жизнь. Через месяц у него начались серьёзные проблемы одна за другой. Морана предупредила о последствиях честно, но результат превзошёл ожидания.",
    stars: 5,
  },
  {
    name: "Елена Р.",
    city: "Казань",
    text: "Долго не могла понять, почему всё в жизни рушится. Диагностика показала сильную порчу — работали над снятием несколько недель. Сейчас чувствую себя абсолютно другим человеком, будто камень с плеч.",
    stars: 5,
  },
  {
    name: "Ольга Т.",
    city: "Краснодар",
    text: "Коллега на работе годами вставляла палки в колёса. Обратилась за порчей на врагов — через две недели она сама уволилась. Совпадение? Не думаю. Спасибо, Морана.",
    stars: 5,
  },
  {
    name: "Наталья Д.",
    city: "Воронеж",
    text: "Подозревала, что на семью наведена порча — постоянные ссоры, болезни, безденежье. После ритуала очищения жизнь начала налаживаться буквально на глазах. Работа проведена очень серьёзно.",
    stars: 5,
  },
  {
    name: "Ирина П.",
    city: "Ростов-на-Дону",
    text: "Полгода не могла найти работу, деньги буквально утекали сквозь пальцы. После ритуала на финансовое процветание всё изменилось за три недели — нашла достойную должность и закрыла долги. Магия Мораны работает по-настоящему.",
    stars: 5,
  },
  {
    name: "Дарья К.",
    city: "Самара",
    text: "Дорогая Морана, обращалась к вам не первый раз. Вы помогли мне успешно сдать экзамены на хорошие оценки. В этот раз обратилась за помощью в отношениях: не понимала, что происходит и почему у меня резко ухудшилось самочувствие — была слабость, резкое похудение, непонятная болезнь. Оказалось, на мне серьёзная порча на смерть, которую вы обнаружили и сняли. Сейчас вы помогаете восстановить отношения с моим мужчиной, и я очень благодарна за участие, скидки и постоянное внимание. Спасибо, что вы есть! Рекомендую обращаться к Моране за ритуалами — это действительно работает!",
    stars: 5,
  },
  {
    name: "Виолетта М.",
    city: "Иркутск",
    text: "Обращаюсь к Моране не в первый раз. В этот раз пришла за ритуалом раскрещивания — решение осознанное и глубоко продуманное, я долго изучала эту тему и понимала, зачем мне это нужно. Морана работает через своих Родовых Богов и объяснила, как снять поставленную печать и восстановить связь с родовыми потоками, вернуть силу, данную при рождении. Результат чувствую по переменам в своей жизни — работа проведена профессионально, как у настоящего мастера своего дела. Благодарна за глубину подхода и честность.",
    stars: 5,
  },
];
      ...
      >
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              Загляните в мир<br />перемен с Ведьмой Мораной
            </h2>
