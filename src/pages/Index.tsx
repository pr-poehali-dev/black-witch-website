...
const SERVICES = [
  {
    icon: "🕯️",
    title: "Ритуалы привязки",
    desc: "Древние обряды для восстановления или укрепления связей между людьми. Работа с тонкими материями судьбы.",
    price: "от 3 000 ₽",
  },
  {
    icon: "🔮",
    title: "Гадание на рунах",
    desc: "Чтение рун — язык богов и предков. Откроет скрытые пути и раскроет тайны прошлого и будущего.",
    price: "от 1 500 ₽",
  },
  {
    icon: "🌑",
    title: "Снятие порчи",
    desc: "Диагностика и очищение от тёмных воздействий. Восстановление энергетической целостности.",
    price: "от 5 000 ₽",
  },
  {
    icon: "⚗️",
    title: "Приворотные зелья",
    desc: "Составление алхимических смесей по древним рецептам. Каждое зелье готовится индивидуально.",
    price: "от 2 500 ₽",
  },
  {
    icon: "🪬",
    title: "Обереги и амулеты",
    desc: "Создание защитных артефактов с индивидуальной программой. Активация в особые лунные фазы.",
    price: "от 800 ₽",
  },
  {
    icon: "📜",
    title: "Заговоры на удачу",
    desc: "Слова силы, проверенные поколениями ведьм. Открывают потоки благополучия и устраняют препятствия.",
    price: "от 2 000 ₽",
  },
];
      ...
      >
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              Двадцать лет<br />в тёмных искусствах
            </h2>
            <div style={{ fontSize: "1.1rem", color: "var(--witch-smoke)", lineHeight: 1.8 }} className="space-y-4">
              <p>Я пришла к магии через бабку — хранительницу знаний рода. В двенадцать лет научилась читать руны, в шестнадцать провела первый самостоятельный обряд.</p>
              <p>
                Моя практика строится на трёх столпах:{" "}
                <span style={{ color: "var(--witch-parchment)" }}>знание традиций</span>,{" "}
                <span style={{ color: "var(--witch-parchment)" }}>работа с энергиями</span> и{" "}
                <span style={{ color: "var(--witch-parchment)" }}>строгая этика</span>.
                Я не обещаю невозможного — только то, что проверено временем.
              </p>
              <p>За годы практики — более трёх тысяч обращений. Работаю дистанционно и лично. Соблюдаю полную конфиденциальность.</p>
            </div>

            <div className="grid grid-cols-3 gap-6 mt-10">
              {[
                { num: "20+", label: "Лет практики" },
                { num: "3000+", label: "Обращений" },
