        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div style={{ fontSize: "1.1rem", color: "var(--witch-smoke)", lineHeight: 1.8 }} className="space-y-4">
              <p>Меня зовут Ольга. Я практикующая ведьма с многолетним опытом работы в эзотерике. Моя миссия — помогать людям находить баланс, счастье и успех через магию и духовные практики.</p>
              <p>
                Я работаю с{" "}
              ...
              <p>
                Каждая ситуация уникальна, как и каждый человек. Моя работа строится на{" "}
                <span style={{ color: "var(--witch-parchment)" }}>внимании к деталям</span>,{" "}
                <span style={{ color: "var(--witch-parchment)" }}>честности</span> и{" "}
                <span style={{ color: "var(--witch-parchment)" }}>гарантии результата</span>{" "}
